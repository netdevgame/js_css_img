function _widget_button_start() {
    ...
    var n = '<a aria-label="' + _widget_settings.buttons.viber.messages + '" ' +
        'class="b24-widget-button-social-item connector-icon connector-icon-viber" ' +
        'href="#" ' +
        'onclick="alert(\'ID Wechat: ' + _widget_settings.buttons.viber.id + '\'); return false;" ' +
        'rel="noopener nofollow" role="button" target="_blank">' +
        '<span class="b24-widget-button-social-tooltip">' + _widget_settings.buttons.viber.messages + '</span></a>';
} else if ("false" == _widget_settings.buttons.viber.visible) {
    var n = "";
} else {
    alert("You must set the visible value to true or false");
}
    if ("true" == _widget_settings.buttons.telegram.visible) var a = '<a aria-label="' + _widget_settings.buttons.telegram.messages + '" class="b24-widget-button-social-item connector-icon connector-icon-telegrambot" href="https://t.me/' + _widget_settings.buttons.telegram.id + '" rel="noopener nofollow" role="button" target="_blank"><span class="b24-widget-button-social-tooltip">' + _widget_settings.buttons.telegram.messages + "</span></a>";
    ...
    if ("true" == _widget_settings.buttons.facebook.visible) var l = '<a aria-label="' + _widget_settings.buttons.facebook.messages + '" class="b24-widget-button-social-item connector-icon connector-icon-facebook" href="https://m.me/' + _widget_settings.buttons.facebook.id + '" rel="noopener nofollow" role="button" target="_blank"><span class="b24-widget-button-social-tooltip">' + _widget_settings.buttons.facebook.messages + "</span></a>";
