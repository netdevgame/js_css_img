function _widget_button_start() {
    ...
    if ("true" == _widget_settings.buttons.viber.visible) var n = '<a aria-label="' + _widget_settings.buttons.viber.messages + '" class="b24-widget-button-social-item connector-icon connector-icon-viber" href="https://www.wechat.com" rel="noopener nofollow" role="button" target="_blank"><span class="b24-widget-button-social-tooltip">' + _widget_settings.buttons.viber.messages + "</span></a>";
